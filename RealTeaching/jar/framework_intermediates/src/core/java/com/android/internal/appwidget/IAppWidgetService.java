...
boolean _result = this.bindAppWidgetIdIfAllowed(_arg0, _arg1, _arg2);
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
...
public void updateAppWidgetOptions(int appWidgetId, android.os.Bundle extras) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public android.os.Bundle getAppWidgetOptions(int appWidgetId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
public boolean hasBindAppWidgetPermission(java.lang.String packageName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
public void setBindAppWidgetPermission(java.lang.String packageName, boolean permission) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public boolean bindAppWidgetIdIfAllowed(java.lang.String packageName, int appWidgetId, android.content.ComponentName provider) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
...
static final int TRANSACTION_updateAppWidgetOptions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_getAppWidgetOptions = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_partiallyUpdateAppWidgetIds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_updateAppWidgetProvider = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_notifyAppWidgetViewDataChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_getInstalledProviders = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_getAppWidgetInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
static final int TRANSACTION_hasBindAppWidgetPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 15);
static final int TRANSACTION_setBindAppWidgetPermission = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_bindAppWidgetId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_bindAppWidgetIdIfAllowed = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_bindRemoteViewsService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_unbindRemoteViewsService = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_getAppWidgetIds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
}
//
// for AppWidgetHost
//
