...
case TRANSACTION_setAutoBrightnessAdjustment:
{
data.enforceInterface(DESCRIPTOR);
float _arg0;
_arg0 = data.readFloat();
this.setAutoBrightnessAdjustment(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_goToBootFastSleep:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
this.goToBootFastSleep(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_bootFastWake:
{
data.enforceInterface(DESCRIPTOR);
long _arg0;
_arg0 = data.readLong();
...
public void setAutoBrightnessAdjustment(float adj) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setAutoBrightnessAdjustment, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
//fake shutdown to boot fast

public void goToBootFastSleep(long time) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeLong(time);
mRemote.transact(Stub.TRANSACTION_goToBootFastSleep, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void bootFastWake(long time, boolean noChangeLights) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
_data.writeLong(time);
_data.writeInt(((noChangeLights)?(1):(0)));
mRemote.transact(Stub.TRANSACTION_bootFastWake, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_setAutoBrightnessAdjustment = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_goToBootFastSleep = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_bootFastWake = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
}
// WARNING: changes in acquireWakeLock() signature must be reflected in IPowerManager.cpp/h
