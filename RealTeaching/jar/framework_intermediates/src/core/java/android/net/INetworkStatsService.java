...
static final int TRANSACTION_forceUpdate = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_advisePersistThreshold = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
}
/** Start a statistics query session. */
public android.net.INetworkStatsSession openSession() throws android.os.RemoteException;
/** Return network layer usage total for traffic that matches template. */
