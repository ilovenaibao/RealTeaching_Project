...
case TRANSACTION_setDreamComponent:
{
data.enforceInterface(DESCRIPTOR);
...
this.setDreamComponent(_arg0);
reply.writeNoException();
return true;
}
case TRANSACTION_getDreamComponent:
{
data.enforceInterface(DESCRIPTOR);
android.content.ComponentName _result = this.getDreamComponent();
reply.writeNoException();
if ((_result!=null)) {
reply.writeInt(1);
...
public void setDreamComponent(android.content.ComponentName componentName) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_setDreamComponent, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public android.content.ComponentName getDreamComponent() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
...
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getDreamComponent, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
...
static final int TRANSACTION_setDreamComponent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 2);
static final int TRANSACTION_getDreamComponent = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_testDream = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
}
public void dream() throws android.os.RemoteException;
public void awaken() throws android.os.RemoteException;
public void setDreamComponent(android.content.ComponentName componentName) throws android.os.RemoteException;
