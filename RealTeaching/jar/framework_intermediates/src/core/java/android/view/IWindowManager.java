...
case TRANSACTION_getCurrentSizeRange:
{
data.enforceInterface(DESCRIPTOR);
android.graphics.Point _arg0;
_arg0 = new android.graphics.Point();
...
this.getCurrentSizeRange(_arg0, _arg1);
reply.writeNoException();
if ((_arg0!=null)) {
reply.writeInt(1);
_arg0.writeToParcel(reply, android.os.Parcelable.PARCELABLE_WRITE_RETURN_VALUE);
...
case TRANSACTION_resetInputCalibration:
{
data.enforceInterface(DESCRIPTOR);
this.resetInputCalibration();
reply.writeNoException();
return true;
}
}
...
public void getCurrentSizeRange(android.graphics.Point smallestSize, android.graphics.Point largestSize) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getCurrentSizeRange, _data, _reply, 0);
_reply.readException();
if ((0!=_reply.readInt())) {
smallestSize.readFromParcel(_reply);
}
if ((0!=_reply.readInt())) {
largestSize.readFromParcel(_reply);
}
}
finally {
_reply.recycle();
...
public void overridePendingAppTransitionThumb(android.graphics.Bitmap srcThumb, int startX, int startY, android.os.IRemoteCallback startedCallback, boolean delayed) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
public void resetInputCalibration() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_resetInputCalibration, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getCurrentSizeRange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
static final int TRANSACTION_setForcedDisplaySize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 9);
static final int TRANSACTION_clearForcedDisplaySize = (android.os.IBinder.FIRST_CALL_TRANSACTION + 10);
static final int TRANSACTION_hasSystemNavBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
static final int TRANSACTION_pauseKeyDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 12);
static final int TRANSACTION_resumeKeyDispatching = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
...
static final int TRANSACTION_addAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_setAppGroupId = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_setAppOrientation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_getAppOrientation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_setFocusedApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_prepareAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_getPendingAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_overridePendingAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_overridePendingAppTransitionScaleUp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_overridePendingAppTransitionThumb = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_executeAppTransition = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_setAppStartingWindow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setAppWillBeHidden = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_setAppVisibility = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_startAppFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_stopAppFreezingScreen = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_removeAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_moveAppToken = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_moveAppTokensToTop = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_moveAppTokensToBottom = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_updateOrientationFromAppTokens = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_setNewConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_disableKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_reenableKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_exitKeyguardSecurely = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_isKeyguardLocked = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_isKeyguardSecure = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_inKeyguardRestrictedInputMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_dismissKeyguard = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_closeSystemDialogs = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_getAnimationScale = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_getAnimationScales = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_setAnimationScale = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_setAnimationScales = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_setInTouchMode = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_showStrictModeViolation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_setStrictModeVisualIndicatorPreference = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_updateRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_getRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_watchRotation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
...
static final int TRANSACTION_screenshotApplications = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_statusBarVisibilityChanged = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_waitForWindowDrawn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_hasNavigationBar = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_lockNow = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_resetInputCalibration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
}
/**
     * ===== NOTICE =====
     * The first three methods must remain the first three methods. Scripts
