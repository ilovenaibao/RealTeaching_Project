...
static final int TRANSACTION_getName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_getUuids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
...
static final int TRANSACTION_readOutOfBandData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 16);
static final int TRANSACTION_getAdapterConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 17);
static final int TRANSACTION_getProfileConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 18);
static final int TRANSACTION_changeApplicationBluetoothState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 19);
static final int TRANSACTION_createBond = (android.os.IBinder.FIRST_CALL_TRANSACTION + 20);
static final int TRANSACTION_createBondOutOfBand = (android.os.IBinder.FIRST_CALL_TRANSACTION + 21);
static final int TRANSACTION_cancelBondProcess = (android.os.IBinder.FIRST_CALL_TRANSACTION + 22);
static final int TRANSACTION_removeBond = (android.os.IBinder.FIRST_CALL_TRANSACTION + 23);
static final int TRANSACTION_listBonds = (android.os.IBinder.FIRST_CALL_TRANSACTION + 24);
static final int TRANSACTION_getBondState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 25);
static final int TRANSACTION_setDeviceOutOfBandData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 26);
static final int TRANSACTION_getRemoteName = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getRemoteAlias = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_setRemoteAlias = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_getRemoteClass = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_getRemoteUuids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_fetchRemoteUuids = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_getRemoteServiceChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_setPin = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
static final int TRANSACTION_setPasskey = (android.os.IBinder.FIRST_CALL_TRANSACTION + 35);
static final int TRANSACTION_setPairingConfirmation = (android.os.IBinder.FIRST_CALL_TRANSACTION + 36);
static final int TRANSACTION_setRemoteOutOfBandData = (android.os.IBinder.FIRST_CALL_TRANSACTION + 37);
static final int TRANSACTION_cancelPairingUserInput = (android.os.IBinder.FIRST_CALL_TRANSACTION + 38);
static final int TRANSACTION_setTrust = (android.os.IBinder.FIRST_CALL_TRANSACTION + 39);
static final int TRANSACTION_getTrustState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 40);
static final int TRANSACTION_isBluetoothDock = (android.os.IBinder.FIRST_CALL_TRANSACTION + 41);
static final int TRANSACTION_addRfcommServiceRecord = (android.os.IBinder.FIRST_CALL_TRANSACTION + 42);
static final int TRANSACTION_removeServiceRecord = (android.os.IBinder.FIRST_CALL_TRANSACTION + 43);
static final int TRANSACTION_allowIncomingProfileConnect = (android.os.IBinder.FIRST_CALL_TRANSACTION + 44);
static final int TRANSACTION_connectHeadset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 45);
static final int TRANSACTION_disconnectHeadset = (android.os.IBinder.FIRST_CALL_TRANSACTION + 46);
static final int TRANSACTION_notifyIncomingConnection = (android.os.IBinder.FIRST_CALL_TRANSACTION + 47);
static final int TRANSACTION_connectInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 48);
static final int TRANSACTION_disconnectInputDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 49);
static final int TRANSACTION_getConnectedInputDevices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 50);
static final int TRANSACTION_getInputDevicesMatchingConnectionStates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 51);
static final int TRANSACTION_getInputDeviceConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 52);
static final int TRANSACTION_setInputDevicePriority = (android.os.IBinder.FIRST_CALL_TRANSACTION + 53);
static final int TRANSACTION_getInputDevicePriority = (android.os.IBinder.FIRST_CALL_TRANSACTION + 54);
static final int TRANSACTION_isTetheringOn = (android.os.IBinder.FIRST_CALL_TRANSACTION + 55);
static final int TRANSACTION_setBluetoothTethering = (android.os.IBinder.FIRST_CALL_TRANSACTION + 56);
static final int TRANSACTION_getPanDeviceConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 57);
static final int TRANSACTION_getConnectedPanDevices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 58);
static final int TRANSACTION_getPanDevicesMatchingConnectionStates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 59);
static final int TRANSACTION_connectPanDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 60);
static final int TRANSACTION_disconnectPanDevice = (android.os.IBinder.FIRST_CALL_TRANSACTION + 61);
static final int TRANSACTION_registerAppConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 62);
static final int TRANSACTION_unregisterAppConfiguration = (android.os.IBinder.FIRST_CALL_TRANSACTION + 63);
static final int TRANSACTION_connectChannelToSource = (android.os.IBinder.FIRST_CALL_TRANSACTION + 64);
static final int TRANSACTION_connectChannelToSink = (android.os.IBinder.FIRST_CALL_TRANSACTION + 65);
static final int TRANSACTION_disconnectChannel = (android.os.IBinder.FIRST_CALL_TRANSACTION + 66);
static final int TRANSACTION_getMainChannelFd = (android.os.IBinder.FIRST_CALL_TRANSACTION + 67);
static final int TRANSACTION_getConnectedHealthDevices = (android.os.IBinder.FIRST_CALL_TRANSACTION + 68);
static final int TRANSACTION_getHealthDevicesMatchingConnectionStates = (android.os.IBinder.FIRST_CALL_TRANSACTION + 69);
static final int TRANSACTION_getHealthDeviceConnectionState = (android.os.IBinder.FIRST_CALL_TRANSACTION + 70);
static final int TRANSACTION_sendConnectionStateChange = (android.os.IBinder.FIRST_CALL_TRANSACTION + 71);
}
public boolean isEnabled() throws android.os.RemoteException;
public int getBluetoothState() throws android.os.RemoteException;
public boolean enable() throws android.os.RemoteException;
