...
{
data.enforceInterface(DESCRIPTOR);
android.telephony.CellInfo _arg0;
if ((0!=data.readInt())) {
_arg0 = android.telephony.CellInfo.CREATOR.createFromParcel(data);
}
else {
_arg0 = null;
}
...
public void notifyCellInfo(android.telephony.CellInfo cellInfo) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
if ((cellInfo!=null)) {
_data.writeInt(1);
cellInfo.writeToParcel(_data, 0);
}
else {
_data.writeInt(0);
}
...
static final int TRANSACTION_notifyCellInfo = (android.os.IBinder.FIRST_CALL_TRANSACTION + 11);
}
public void listen(java.lang.String pkg, com.android.internal.telephony.IPhoneStateListener callback, int events, boolean notifyNow) throws android.os.RemoteException;
public void notifyCallState(int state, java.lang.String incomingNumber) throws android.os.RemoteException;
public void notifyServiceState(android.telephony.ServiceState state) throws android.os.RemoteException;
